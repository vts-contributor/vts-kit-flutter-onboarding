...
class _AnimatedContainerDisplayState extends State<SheetItem>
    ...
    OverlayEntry overlayEntry = OverlayEntry(
        builder: (BuildContext context) => AnimatedBuilder(
            ...
            builder: (BuildContext context, Widget? child) {
              return Container(
                  color: barrierColorCurrent
                      .withOpacity(widget.barrierOpacity ?? 0.6),
                  child: Stack(
                    children: [
                      GestureDetector(
                          onTap: () {
                      ...
                      Positioned(
                        ...
                        child: Align(
                            alignment:
                                widget.alignSheet ?? Alignment.bottomCenter,
                            child: Stack(
                              children: [
                                SlideTransition(
                                  position: _animation,
                                  child: ClipRRect(
                                      borderRadius: BorderRadius.only(
                                        topLeft: Radius.circular(
                                            widget.radiusTopLeft ?? 30),
                                        topRight: Radius.circular(
                                            widget.radiusTopRight ?? 30),
                                        bottomRight: Radius.circular(
                                            widget.radiusBottomRight ?? 0),
                                        bottomLeft: Radius.circular(
                                            widget.radiusBottomLeft ?? 0),
                                      ),
                                      child: Stack(
                                        children: [
                                          Container(
                                            width: widget.widthSheet ??
                                                MediaQuery.of(context)
                                                    .size
                                                    .width,
                                            height: widget.heightSheet ?? 500,
                                            color: widget.colorSheet ??
                                                Colors.white,
                                            child: Padding(
                                              padding: EdgeInsets.symmetric(
                                                  vertical: widget
                                                          .paddingVerticalContent ??
                                                      20,
                                                  horizontal: widget
                                                          .paddingHorizontalContent ??
                                                      20),
